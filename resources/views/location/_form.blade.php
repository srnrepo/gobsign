...
<div class="col-md-12">
	<div class="form-group">
		...
		{!! Form::input('text','location',isset($location->location) ? $location->location : '',['class'=>'form-control', 'placeholder'=>'Enter Location'])!!}
	</div>
</div>
<div class="col-md-12">
	<div class="form-group">
		{!! Form::label('job',trans('messages.Job Number').' #',[])!!}
		{!! Form::input('text','job_number',isset($location->job_number) ? $location->job_number : '',['class'=>'form-control', 'placeholder'=>'Enter Job Number'])!!}
	</div>
</div>
<div class="col-md-12">
	<div class="form-group">
...
<div class="col-sm-12">
	<div class="form-group margin-bottom5">
		...
		{!! Form::input('text','address1',isset($location->address1) ? $location->address1 : '',['class'=>'form-control', 'placeholder'=>'Enter Address'])!!}
	</div>
	<div class="form-group">
