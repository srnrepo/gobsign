...
<div class="col-sm-12">
    <div class="form-group">
        ...
        {!! Form::input('number','print_rate_per',isset($location->print_rate_per) ? $location->print_rate_per : '',['class'=>'form-control', 'placeholder'=>'$'])!!}
    </div>
</div>
<div class="col-sm-12">
    <div class="form-group">
        {!! Form::label('print_total',trans('messages.Total'),[])!!}
        {!! Form::input('number','print_total',isset($location->print_total) ? $location->print_total : '',['class'=>'form-control', 'placeholder'=>'$'])!!}
    </div>
</div>