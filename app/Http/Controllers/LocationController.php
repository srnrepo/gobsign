...
Class LocationController extends Controller{
	...
	public function create(){
		...
		return view('location.create',compact('clients','top_locations','assets', 'locations'));
	}
    ...
    public function getlocations () {
        ...
        $locations = $this->get_all_locations($_GET['start_date'], $_GET['end_date']);

        return json_encode(array('success' => true, 'data' => $locations));
        //return json_encode(array('success' => true, 'data' => $_GET));
    }
    ...
    protected function get_all_locations($start_date = null, $end_date = null){
        ...
        if(Entrust::hasRole('admin')) {
            if ($start_date != null && $end_date != null)
                $locations = Location::where('created_at', '<=', $start_date)->get();
            else 
                $locations = Location::get();
        } else
            return null;
        ...
        foreach ($locations as $location){
            ...
            $cols = array(
                    ...
                    'top_location' => ($location->top_location_id) ? $location->Parent->location.' ('.$location->Parent->Client->client_name.')' : '',
